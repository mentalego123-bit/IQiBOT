...
import { UserProfile, NavigationTab, BroadcastNotification } from '../types';
import { soundManager } from '../utils/audio';
import { Brain, Swords, Grid, Trophy, Sparkles, ArrowRight, Bell, Zap, Gift, Bot, Crown, Award } from 'lucide-react';
      ...
      <div className="relative rounded-3xl bg-gradient-to-b from-slate-900/95 via-slate-900/90 to-slate-950/98 border border-cyan-500/40 p-6 sm:p-8 shadow-[0_0_35px_rgba(0,210,255,0.15)] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
          ...
          <div className="text-center lg:text-left space-y-4 max-w-xl">
            ...
            {/* Sarlavha va uning yonidagi Ajoyib Kiber Bot Logotipi */}
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
              {/* Animatsiyali Glowing Bot Logotipi */}
              <div className="relative shrink-0 group">
                ...
                <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-slate-950 border-2 border-cyan-400 flex flex-col items-center justify-center shadow-2xl p-2">
                  {/* Golden Crown on top of Bot */}
                  <div className="absolute -top-3.5 flex justify-center">
                    <span className="px-2 py-0.5 rounded-full bg-amber-400/90 text-slate-950 text-[10px] font-extrabold flex items-center gap-0.5 shadow-[0_0_10px_#fbbf24]">
                      <Crown className="w-3 h-3 fill-current text-slate-950" />
                      BOT
                    </span>
                  </div>

                  {/* Bot Head SVG / Icon with glowing visor */}
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-cyan-900/60 to-slate-900 border border-cyan-400/60 flex items-center justify-center text-cyan-300 shadow-[0_0_15px_#00d2ff]">
                    <Bot className="w-7 h-7 text-cyan-300 animate-bounce" style={{ animationDuration: '2.5s' }} />
                  </div>

                  {/* Pulsing visor status light */}
                  <div className="mt-1 flex items-center gap-1 text-[9px] font-mono font-bold text-amber-300">
              ...
              <div className="space-y-2">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-display font-extrabold text-white tracking-tight leading-snug">
