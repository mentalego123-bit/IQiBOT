...
import { Question, ChannelSubscription, UserProfile, AdminSettings, GameLimitSettings } from '../types';
...
type AdminTab = 'monetization' | 'security' | 'weekly' | 'gamelimits' | 'broadcast' | 'questions' | 'channels' | 'analytics' | 'users';
