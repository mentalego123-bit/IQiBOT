  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
      <div className="relative w-full max-w-md bg-slate-900/95 border border-cyan-500/40 rounded-3xl p-6 shadow-2xl shadow-cyan-500/20 text-center">
        ...
        {/* Logo Avatar */}
        <div className="relative mx-auto w-24 h-24 mb-4 rounded-full p-1 bg-gradient-to-tr from-cyan-400 via-blue-500 to-amber-400 shadow-lg shadow-cyan-500/30">
          <img
            src={logoImg}
            alt="IQ Level Uz Logo"
            className="w-full h-full object-cover rounded-full"
          />
          <div className="absolute -bottom-1 -right-1 w-7 h-7 rounded-full bg-amber-400 text-slate-950 font-bold flex items-center justify-center text-xs shadow">
            UZ
          </div>
        </div>
        ...
        <p className="text-xs text-cyan-400 font-mono mt-0.5 tracking-wide">
          DARK NEON CYBERPUNK EDITION
        </p>

        <div className="mt-4 p-3 bg-slate-950/60 rounded-xl border border-cyan-500/20 text-xs text-slate-300">
          <div className="flex items-center justify-center gap-1.5 text-amber-400 font-semibold mb-1">
            <Sparkles className="w-4 h-4" />
            <span>Xush kelibsiz!</span>
          </div>
          Ismingizni kiriting (Sertifikat va reyting uchun)
        </div>
